...
public class FastutilPool implements BeanPool {
    ...
    public <T> void appendBeam(@NonNull Object owner, @NonNull Class<T> service, @Nullable String tag, @NonNull T provider) {
        ...
        try {
            ...
            owners.computeIfAbsent(owner, k -> new ObjectOpenHashSet<>(4)).add(data);
        } finally {
            writeLock.unlock();
        }
    }
